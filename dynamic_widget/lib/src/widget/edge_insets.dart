...
const EdgeInsetsDynamic pagePadding =
    EdgeInsetsDynamic(horizontal: 16, vertical: 8);

const EdgeInsetsDynamic contentPadding =
    EdgeInsetsDynamic(horizontal: 8, vertical: 4);
